...
void token_print(TokenList tokens) {
    ...
    for (size_t i = 0; i < tokens.count; i++) {
        ...
        switch (tokens.items[i].kind) {
            case LEFT_PAREN: printf("LEFT_PAREN"); break;
            case RIGHT_PAREN: printf("RIGHT_PAREN"); break;
            case LEFT_BRACKET: printf("LEFT_BRACKET"); break;
            case RIGHT_BRACKET: printf("RIGHT_BRACKET"); break;
            case LEFT_CURLY: printf("LEFT_CURLY"); break;
            case RIGHT_CURLY: printf("RIGHT_CURLY"); break;
            ...
            case GREATER_EQUAL: printf("GREATER_EQUAL"); break;
            case LESS: printf("LESS"); break;
            case LESS_EQUAL: printf("LESS_EQUAL"); break;
            case COLON_EQUAL: printf("COLON_EQUAL"); break;
            case EQUAL: printf("EQUAL"); break;
            case EQUAL_EQUAL: printf("EQUAL_EQUAL"); break;
            ...
            case INTERFACE: printf("INTERFACE"); break;
            ...
            case LINK_WITH: printf("LINK_WITH"); break;
            case NEW_LINE: printf("NEW_LINE"); break;
            case END_OF_FILE: printf("END_OF_FILE"); break;
        }
        printf("\n");
    }
}
...
char* token_getLiteral(Token token) {
    switch (token.kind) {
        ...
        case BE: return "be";
        case INTEGER: return token.literal.content;
        case FLOAT: return token.literal.content;
        case IDENTIFIER: return token.literal.content;
        case STRING: return token.literal.content;
        case STRING_LEFT: return token.literal.content;
        case STRING_MIDDLE: return token.literal.content;
        case STRING_RIGHT: return token.literal.content;
        case IF: return "if";
