...
namespace semantic {
    ...
    bool are_arguments_compatible(ast::FunctionNode& function, semantic::FunctionsAndTypesScopes& function_and_types_scopes, ast::CallNode& call, std::vector<ast::Type> function_types, std::vector<ast::Type> argument_types);
}
