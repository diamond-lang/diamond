...
namespace errors {
    ...
    std::string unexpected_argument_type(ast::CallNode& call, std::filesystem::path file, size_t arg_index, ast::Type type_received, std::vector<ast::Type> expected_types);
    std::string unexpected_return_type(ast::CallNode& call, std::filesystem::path file, ast::Type type_received, std::vector<ast::Type> expected_types);
    std::string unexpected_argument_types(ast::CallNode& call, std::filesystem::path file, size_t arg_index, std::vector<ast::Type> types_received, std::vector<ast::Type> expected_types);
